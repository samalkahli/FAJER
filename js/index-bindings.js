...
document.querySelector('[data-bind-click="index-3"]').addEventListener("click",function(event){if(event.target.matches('input[type="file"]')) return;backToGateway();});
...
document.querySelector('[data-bind-click="index-5"]').addEventListener("click",function(event){if(event.target.matches('input[type="file"]')) return;backToCategories();});
document.querySelector('[data-bind-click="index-6"]').addEventListener("click",function(event){if(event.target.matches('input[type="file"]')) return;backToCategories();});
