...
const labels={background:'خلفية الشريحة',box:'داخل مربع',plain:'شعار بدون مربع',contain:'كامل بدون قص',cover:'ملء المساحة مع القص',center:'وسط',right:'يمين',left:'يسار'};
